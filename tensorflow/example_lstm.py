...
class LSTMRNN(object):
    ...
    def _weight_variable(self,shape,name='weights'):
        ...
        tf.get_variable(shape=shape,initializer=initializer,name=name)
...
if __name__=='__main__':
    ...
    sess=tf.Session()
    merged=tf.merge_all_summareis()
    writer=tf.trian.SummaryWriter('logs',sess.graph)
