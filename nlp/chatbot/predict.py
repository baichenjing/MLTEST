...
from nlp.chatbot.data_loader import loadDataset, sentence2enco
from nlp.chatbot.model import Seq2SeqModel
import sys
import numpy as np
...
def predict_ids_to_seq(predict_ids,id2word,beam_size):
    for single_predict in predict_ids:
        predict_list=np.ndarray.tolist(single_predict[:,:,beam_size])
